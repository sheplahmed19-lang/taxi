...
Flutter driver app. This directory currently contains only the Dart source
...
flutter create . --org com.rideplatform --project-name driver_app
...
Phase 0.6 / 1.7 for what to build next.
